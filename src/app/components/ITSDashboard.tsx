        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="col-span-2">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3.5 bg-muted/30 border border-border rounded-xl">
                <div>
                  <p className="text-xs font-bold text-foreground">Maintenance Operations Manager</p>
                  <p className="text-[11px] text-muted-foreground mt-0.5">Handle queued repair tickets and inspection cycles</p>
                </div>
                <Button size="sm" onClick={() => navigate(`/${overviewSlug}/maintenance`)} className="gap-1 text-xs">
